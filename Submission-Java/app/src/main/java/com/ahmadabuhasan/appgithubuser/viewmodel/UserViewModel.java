...
import com.ahmadabuhasan.appgithubuser.api.ApiService;
...
public class UserViewModel extends ViewModel {
    ...
    private final MutableLiveData<UserDetail> userMutableLiveData = new MutableLiveData<>();
    ...
    public void setUserDetail(String dataUser) {
        try {
            ...
            Call<UserDetail> call = apiService.detailUser(dataUser);
